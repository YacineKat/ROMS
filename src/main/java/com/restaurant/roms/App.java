...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            // Load splash screen
            URL splashUrl = getClass().getResource("/fxml/splashE.fxml");
            if (splashUrl == null) {
            ...
            pause.setOnFinished(event -> {
                try {
                    ...
                    URL welcomeUrl = getClass().getResource("/com/restaurant/roms/welcome.fxml");
                    URL cssUrl = getClass().getResource("/com/restaurant/roms/menu-style.css");
